<!-- 
电子科技大学交叉学科协会 | Interdisciplinary Association of UESTC
Organization Profile README
Repo: https://github.com/UESTC-IA/.github
-->
...
#### 🎯 核心方向
- **Science**：AI for Science（如蛋白质预测、新材料发现）  
- **Health**：智能医疗、医学影像、可穿戴设备  
- **Engineering**：具身智能、芯片设计、通信系统  
- **Finance**：金融科技、量化分析、智能风控  
- **AI Methods**：机器学习、深度学习、数据科学核心技术支持

#### 🚀 我们的使命
- 构建校内首个“AI+X”跨学科实践平台  
- 链接头部企业（如深势科技）、科研机构与校内实验室  
- 通过项目实战、竞赛、讲座与企业参访，培养复合型创新人才  
- 推动真实世界的前沿问题解决与成果转化

#### 📅 品牌活动
- **“AI × Future”交叉学科创新挑战赛**（全校性赛事）  
- **AI Methods 技术工作坊**（每周/双周）  
- **教授下午茶 & 圆桌论坛**  
- **年度成果展示会 & 暑期科研实践计划**
